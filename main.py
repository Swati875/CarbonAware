...
async def api_calculate(request: CalculationRequest):
    try:
        ...
        raise HTTPException(status_code=500, detail="Internal server error occurred during calculation.")
...
async def api_get_history():
    try:
        ...
        raise HTTPException(status_code=500, detail="Internal server error occurred while retrieving history.")
...
async def api_get_goals():
    try:
        ...
        raise HTTPException(status_code=500, detail="Internal server error occurred while retrieving goals.")
...
async def api_toggle_goal(goal_id: str, completed: bool = Body(..., embed=True)):
    try:
        ...
        logger.exception(f"Error toggling goal {goal_id}")
        raise HTTPException(status_code=500, detail="Internal server error occurred while updating goal.")
...
async def api_get_badges():
    try:
        ...
        raise HTTPException(status_code=500, detail="Internal server error occurred while retrieving achievements.")
...
async def api_coach(request: CoachRequest):
    try:
        ...
        raise HTTPException(status_code=500, detail="Internal server error occurred while contacting the AI coach.")
...
async def api_get_metrics():
    try:
        ...
        raise HTTPException(status_code=500, detail="Internal server error occurred while loading server metrics.")
...
async def root():
    ...
    return {"message": "Carbon app running! Create index.html in the static directory to view the web dashboard."}
